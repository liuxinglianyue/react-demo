...
const knightSpec = {
    ...
    beginDrag(props, monitor, component) {
         ...
         */
        return {
            id: `pools_dir_${Util.randHash()}`,
            key: `key_pools_dir_${Util.randHash()}`,
            type: proConfig.nodeFlowType.poolsDirection,
            width: 420,
            height: 800,
            name: "纵向泳池",
            documentation: ""
    ...
    render() {
        ...
        return connectDragSource(
            ...
            >
                <Row>
                    <Col span={6} offset={5}>
                        <div className="pools-dir-node-img"></div>
                    </Col>
                    <Col span={13}>
                        <div className="contentTitle">纵向包括框</div>
                    </Col>
                </Row>
            </div>
        )
