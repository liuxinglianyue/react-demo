...
import {
  actionCreators as actionCreatorsGlobal,
  actionCreators
} from "../../storeGlobal";
import {
  actionCreators as actionCreatorsTool
} from "../../storeTool";
import {
  actionCreators as actionCreatorsProperty
} from "../../storeProperty";
...
export default class Index extends Component {
  ...
  addEndpoint(id, xname, yname) {
    ...
    this.jsPlumbForword.addEndpoint(id, {
      anchors: anchors,
      uuid: `${id}-anchor-${xname}-${yname}`
    }, commonConfig);
  }
    ...
    originalData.forEach((item) => {
      ...
      infoObj = {
        ...
        "nodeData": [{
          ...
          "documentation": "",
          "type": "userTask",
          "id": "usertask_activity_T14P1NEQ1609828242858",
          "formKey": ""
        }],
        "connectionData": [{
          "id": "con_6",
          ...
          "name": "es",
          "source": {
            "elementId": "start_X3S3DV1609828242049",
            "x": 209,
            "y": 334
          },
          "target": {
            "elementId": "usertask_activity_T14P1NEQ1609828242858",
            "x": 608,
            "y": 436
          }
        }]
  ...
  render() {
    return ( <
      ...
      <
      ToolsBar dropDownCB = {
        (dropInfo) => this.handleDropDown(dropInfo)
      }
      jsplumGetConnections = {
        this.jsPlumbForword.getConnections.bind(this)
      }
      /> <
      /div> <
      /div> <
      ...
      <
      Input placeholder = "请输入label名称"
      onChange = {
        this.onChange
      }
      value = {
        this.state.connectInputValue
      }
      /> <
      /Modal> <
      Modal title = "提示"
      visible = {
        this.state.visibleConnection
      }
      onOk = {
      ...
      p > 确定删除所点击的连接线吗 < /p> <
      /Modal> <
      NodeFlowRightMenu jsplumbGetAllConnections = {
        this.jsPlumbForword.getAllConnections
      }
      jsplumbDeleteConnectionsForElement = {
        this.jsPlumbForword.deleteConnectionsForElement.bind(this)
      }
      EndpointsDataArray = {
        this.EndpointsDataArray
      }
